...
def create_vari_vudoo(num_designs: int, design_name: str):
    ...
    for x in range(num_designs):
        ...
        stear_wing_chord = round(
            float(rand_wing_params[0]["CHORD_1"]["assigned"]))
        stear_wing_span = round(float(rand_wing_params[0]["SPAN"]["assigned"]))
        stear_wing_load = round(float(rand_wing_params[0]["LOAD"]["assigned"]))
